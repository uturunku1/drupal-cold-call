...
function mayo_theme() {
  ...
  'render element' => 'form',
  'path' => drupal_get_path('theme', 'mayo') . '/templates',
  'template' => 'user-login',
  'preprocess functions' => array(
  'mayo_preprocess_user_login'
  ),
 );
return $items;
}
function mayo_preprocess_user_login(&$vars) {
  $vars['intro_text'] = t('Welcome to Cold Call Game!');
}
/**
...
function mayo_preprocess_html(&$variables) {
  // if (!$variables["is_front"] && $variables["logged_in"]!=null) {
